{
  ...
  devenv_root = "/Users/surenrao/nix";
  project_input_ref = "path:/Users/surenrao/nix";
  devenv_dotfile = "/Users/surenrao/nix/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/var/folders/k4/fdp8y3sj5v19r9shf_tx0gjm0000gn/T/";
  devenv_runtime = "/var/folders/k4/fdp8y3sj5v19r9shf_tx0gjm0000gn/T/devenv-3e6e4fe";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "Suryas-MacBook-Pro-2024.local";
  username = "surenrao";
  git_root = "/Users/surenrao/nix";
  secretspec = null;
};
    in
    {
